...
const NSInteger kClusterWidth = 260;
...
- (void)setPoiArray:(NSArray *)poiArrayy
{
    ...
    self.frame = CGRectMake(0, 0, kClusterWidth, height);
    
    self.tableview.frame = CGRectMake(kCornerRadius, kTableViewMargin, kClusterWidth - kCornerRadius * 2, height - kArrorHeight - kTableViewMargin * 2);
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    CDAnno *poi = [self.poiArray objectAtIndex:indexPath.row];
    cell.textLabel.text = poi.markerInfo.title;
    cell.detailTextLabel.text = poi.markerInfo.markerDescription;
